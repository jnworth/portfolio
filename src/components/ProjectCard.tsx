    ...
    >
      <Link to={`/projects/${project.id}`} className="block">
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
          {/* Image */}
          <div className={`aspect-video relative overflow-hidden ${project.imageUrl && !project.imageUrl.includes('placeholder') ? 'bg-gray-950' : 'bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700'}`}>
